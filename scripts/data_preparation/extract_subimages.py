...
def main():
    ...
    # HR images
    opt['input_folder'] = '/gdata1/zhengns/data/Div2k/DIV2K_train_HR'
    opt['save_folder'] = '/gdata1/zhengns/data/Div2k/train_HR_patch'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx2 images
    opt['input_folder'] = '/gdata1/zhengns/data/Div2k/train_LR'
    opt['save_folder'] = '/gdata1/zhengns/data/Div2k/train_LR_patch'
    opt['crop_size'] = 240
    opt['step'] = 120
    opt['thresh_size'] = 0
    extract_subimages(opt)
